...
#include "orderbookdex_base_tester.hpp"
...
class orderbookdex_tester : public orderbookdex_base_tester {
public:
...
BOOST_AUTO_TEST_SUITE(orderbookdex_tests)

BOOST_FIXTURE_TEST_CASE( init_tests, orderbookdex_tester ) try {
...
BOOST_FIXTURE_TEST_CASE( update_pubkey_test, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( create_negative_max_supply, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( symbol_already_exists, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( create_max_supply, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( create_max_decimals, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( issue_tests, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( retire_tests, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( transfer_tests, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( open_tests, orderbookdex_tester ) try {
...
// BOOST_FIXTURE_TEST_CASE( close_tests, orderbookdex_tester ) try {
